...
class EngineCoreOutput(
    ...
    # Block hashes for the request's KV cache blocks (hex-encoded).
    # Used for non-contiguous prefix caching and selective eviction.
    block_hashes: list[str] | None = None
    # Block size in tokens for interpreting block_hashes.
